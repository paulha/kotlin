...
public class ResolutionResultsHandler {
    ...
    private static <D extends CallableDescriptor> Set<MutableResolvedCall<D>> filterOutEquivalentCalls(
        ...
        List<MutableResolvedCall<D>> fromSourcesGoesFirst =
                CollectionsKt.sortedBy(candidates, new Function1<MutableResolvedCall<D>, Integer>() {
                    @Override
                    public Integer invoke(MutableResolvedCall<D> resolvedCall) {
